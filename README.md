...
إذا كانت قاعدة البيانات فارغة تماماً، سيتم أيضاً إنشاء لعبة افتراضية باسم `اللعبة الرئيسية` داخل كل فرع نشط حتى يمكن تسجيل الدخول مباشرة، ويجب تغيير كلمة سر المستخدم الافتراضي بعد أول دخول لأسباب أمنية.
