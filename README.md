...
تم أيضاً تجهيز مستخدم افتراضي للدخول إلى لوحة النظام:
...
إذا كانت قاعدة البيانات فارغة تماماً، سيتم أيضاً إنشاء لعبة افتراضية باسم `اللعبة الرئيسية` داخل كل فرع نشط حتى يمكن تسجيل الدخول مباشرة.
